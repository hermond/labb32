...
class LoginView implements \login\model\LoginObserver {
    ...
    private static $registrationSuccess = "Registrering av ny användare lyckades!";
	...
	public function setRegistrationSuccessMessage()
    {
        $this->message = self::$registrationSuccess;
    }
}
